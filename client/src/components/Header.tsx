                ...
                <div className="absolute top-full right-0 pt-2 z-50">
                  <div className="bg-white rounded-lg shadow-2xl py-1.5 min-w-[160px] border border-gray-200">
                    {languages.map((lang) => (
                      <button
                        key={lang.code}
                        className="notranslate w-full flex items-center gap-2.5 px-3.5 py-2 text-[13px] text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all text-left"
                        translate="no"
                        onClick={() => {
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-6">
          <Link href="/" data-testid="link-logo">
            <img src="/images/logo.webp" alt="Copyprint.ie" className="h-9 md:h-11 w-auto cursor-pointer" width="360" height="98" />
          </Link>
              ...
              <SheetContent side="right" className="bg-white border-gray-200 w-[300px] flex flex-col overflow-hidden">
                <SheetHeader className="flex-shrink-0">
                  <SheetTitle className="text-left">
                    <img src="/images/logo.webp" alt="Copyprint.ie menu" className="h-9 w-auto" width="360" height="98" />
                  </SheetTitle>
                </SheetHeader>
